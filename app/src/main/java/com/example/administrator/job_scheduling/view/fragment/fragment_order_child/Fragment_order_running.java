...
public class Fragment_order_running extends Fragment {

    private View view;
    private static String TAG = "Fragment_order_running";
    private ArrayList<OrderBean> orderBeans;

    public static Fragment_order_running newInstance() {
        Fragment_order_running fragment_room_style1 = new Fragment_order_running ();
        Bundle b = new Bundle ();
